...
function gencoordpar(mysim::M3GTools.Simulation, atoms::Vector, ys, dmax) #mysim = simulação, atoms = vetor de atomos de oxigênio, yw = y do oxigênio, ys = y da superfície, yb = y da caixa, dmax = distancia da primeira camada de solvatação
